...
options = {
  ...
  colors: ["#de8244", "#4e72be"],
  xaxis: {
    categories: ["Climate Change", "Anti-Corruption Policies", "Wages", "Inclusivity", "Water Consumption", "Environment Management", "Carbon Footprint"]
  },
  yaxis: {
    title: {
      text: "",
...
(chart = new ApexCharts(document.querySelector("#comparison-peers"), options)).render();
options = {
  chart: {
    height: 350,
    type: "bar",
...
options = {
  ...
  series: [40, 25, 41, 37, 15, 6, 22, 30],
  labels: ["Perak", "Sabah", "Selangor", "Sarawak", "Melaka", "Penang", "Johor", "Kedah"],
  colors: ["#34c38f", "#556ee6", "#f46a6a", "#50a5f1", "#f1b44c", "#ff0", "#995454", "#ba45cf"],
  legend: {
    show: !0,
    position: "bottom",
...
(chart = new ApexCharts(document.querySelector("#pie_state"), options)).render();
options = {
  chart: {
    height: 320,
    type: "donut"
...
options = {
  ...
  series: [30, 24, 35, 17, 5],
  labels: ["5 employees", "20 employees", "50 employees", "100 employees", "More than 100 employees"],
  colors: ["#34c38f", "#556ee6", "#f46a6a", "#50a5f1", "#f1b44c"],
  legend: {
    show: !0,
    position: "bottom",
...
(chart = new ApexCharts(document.querySelector("#pie_size"), options)).render();
options = {
  chart: {
    height: 320,
    type: "donut"
...
options = {
  ...
  series: [30, 14, 65, 17, 55],
  labels: ["Agriculture", "Construction", "Food", "Energy", "Wholesale & Retail"],
  colors: ["#34c38f", "#556ee6", "#f46a6a", "#50a5f1", "#f1b44c"],
  legend: {
    show: !0,
    position: "bottom",
...
(chart = new ApexCharts(document.querySelector("#pie_industry"), options)).render();
options = {
  chart: {
    height: 320,
    type: "donut"
...
options = {
  ...
  series: [130, 224, 65, 97, 255, 88, 165, 210, 67, 118, 44, 221],
  labels: ["Selangor", "Federal Territory of Kuala Lumpur", "Sabah", "Sarawak", "Pahang", "Perlis", "Kelantan", "Terengganu", "Negeri Sembilan", "Perak", "Johor", "Melaka"],
  colors: ["#aecde1", "#ad96c4", "#c4b79c", "#d5443d", "#8e9b63", "#f5de18", "#92f1d7", "#eab0f8", "#b0f4f8", "#e6f8b0", "#c9cac6"],
  legend: {
    show: !0,
    position: "left",
    horizontalAlign: "center",
...
(chart = new ApexCharts(document.querySelector("#sme-by-state"), options)).render();
options = {
  chart: {
    height: 320,
    type: "donut"
...
options = {
  ...
  series: [30, 124, 85, 27, 76, 88, 102, 230],
  labels: ["Manufacturing", "Construction", "Consultancy & Other Services", "Agribusiness", "Energy", "Healthcare & Pharmaceutical", "Media & ICT", "Transport & Logistics"],
  colors: ["#efbf8b", "#eeb3a9", "#eee5a9", "#b9eea9", "#6ad5a9", "#6ed6e9", "#858df1", "#cf85f1"],
  legend: {
    show: !0,
    position: "left",
    horizontalAlign: "center",
...
(chart = new ApexCharts(document.querySelector("#sme-by-industry"), options)).render();
options = {
  chart: {
    height: 320,
    type: "donut"

...
class HomeController extends Controller
{
    ...
    public function root()
    {
        ...
        $linkeduser = DB::table('users')->select('*')
        ...
        if (auth()->user()->access_level == 'sme') {
            return view('indexsme',compact('linkeduser'));
        }
        else if (auth()->user()->access_level == 'corporate')
        {
            return view('index',compact('linkeduser'));
        }
    ...
    // protected function add_linked_user1(array $data)
    // {
    //     return User::create([

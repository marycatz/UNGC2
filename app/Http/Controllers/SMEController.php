...
{
    //
    public function add_linked_user_sme(Request $request)
    {
    ...
    public function edit_linked_user_process_sme(Request $request)
    {
    //     dd($request->input('company_id'));
        ...
        ->where('id', $user_id)
        ->update(['name' => $name , 'email' => $email ,'access_level'=>$access_level, 'position'=>$position, 'company_id'=>$company_id, 'access_group'=> $access_group,  'phone' => $phone]);

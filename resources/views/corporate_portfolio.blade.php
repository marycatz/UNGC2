        ...
        <ul class="nav nav-tabs nav-pills" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link " data-bs-toggle="tab" href="#profile" role="tab">
                    ...
                    <span class="d-none d-sm-block">SME Currently Sharing</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link " data-bs-toggle="tab" href="#sme" role="tab">
                    <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                    <span class="d-none d-sm-block">SME</span>
                </a>
            </li>
        </ul>
        <!-- Tab panes -->
        <div class="tab-content text-muted">
        <div class="tab-pane" id="sme" role="tabpanel">
                </br>
                <div class="col-12">
                                    ...
                                    <table class="table align-middle table-nowrap table-check">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-warning btn-rounded waves-effect waves-light" style="height: 33px;">Request Connection</button>&nbsp;<button type="button" class="btn btn-danger btn-rounded waves-effect waves-light" style="height: 33px;">Ignore</button> </td>
                                            </tr>
                                            <tr  style="background-color: rgb(233, 233, 233);">
                                                <td>2</td>
            ...
            <div class="tab-pane" id="profile" role="tabpanel">
                ...
                <div class="col-12">
                    <h5>List of SMEs currently sharing</h5>
                </div>
                </br>
                <div class="row">
                    <div class="col-12">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><button type="button" class="btn btn-success btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Assessments</button>
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" style="height: 33px;">View Profile</button> 
                                                    <button type="button" class="btn btn-warning btn-rounded waves-effect waves-light" style="height: 33px;">Unshare</button></td>
                                            </tr>
                                            <tr  style="background-color: rgb(233, 233, 233);">
                                                <td>2</td>
                                                ...
                                                <td><button type="button" class="btn btn-success btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target=".bs-example-modal-center">Assessments</button>
                                                    ...
                                                    <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light" style="height: 33px;">View Profile</button> 
                                                    <button type="button" class="btn btn-warning btn-rounded waves-effect waves-light" style="height: 33px;">Unshare</button></td></td>
                                            </tr>
                                            <tr>
                                                <td>3</td>

            ...
            <!-- <form class="app-search d-none d-lg-block">
              ...
              <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect">
                    <h2 style="color:white;margin-top:10px;">ACCESS : Corporate </h2>
                </button>
            </div>
...
<div class="dropdown d-inline-block">
    ...
    @if(url()->current() == "http://127.0.0.1:8000/pagecorp")
        <a class="" style="color:White;" href="{{ route('landinghome') }}">Home</a>&nbsp;&nbsp;&nbsp;
    @else
    <a class="" style="color:White;" href="{{ route('pagecorp') }}">Home</a>&nbsp;&nbsp;&nbsp;
    @endif
